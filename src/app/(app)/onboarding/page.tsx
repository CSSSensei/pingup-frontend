...
const STEPS = [
  { label: "Шаг 1 из 5", title: "Какой у вас уровень?", sub: "Подберём напарников по силам. Уровень можно изменить в любой момент." },
  { label: "Шаг 2 из 5", title: "Немного о себе", sub: "Фото и пара деталей помогут напарникам узнать вас на игре." },
  { label: "Шаг 3 из 5", title: "Ваша экипировка", sub: "Необязательно — но интересно тем, кто подбирает спарринг по инвентарю." },
  { label: "Шаг 4 из 5", title: "Как с вами связаться", sub: "Контакты увидят только подтверждённые напарники по игре." },
